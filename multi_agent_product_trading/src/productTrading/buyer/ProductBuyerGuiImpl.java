...
public class ProductBuyerGuiImpl extends JFrame implements ProductBuyerGui { 

	 private ProductBuyerAgent myAgent;
	    ...
	    private JButton setCCB, buyB, resetB, exitB, kollu;
	    ...
	    rootPanel.setPreferredSize(new Dimension(330, 125));
	        ...
	        JLabel l = new JLabel("Prod to buy:");
	   ...
	   gridBagConstraints.gridy = 2;
	    ...
	    setDeadlineB.setPreferredSize(new Dimension(70, 20));
	        ...
	        public void actionPerformed(ActionEvent e) {
	            ...
	            if (tc.showEditTimeDlg(ProductBuyerGuiImpl.this) == TimeChooser.OK) {
	    ...
	    setCCB = new JButton("Set CreditCard");
	        ...
	        public void actionPerformed(ActionEvent e) {
	            ...
	            String cc = JOptionPane.showInputDialog(ProductBuyerGuiImpl.this, "Insert the Credit Card number");
	            ...
	            if (cc != null && cc.length() > 0) {
	                ...
	                JOptionPane.showMessageDialog(ProductBuyerGuiImpl.this, "Invalid Credit Card number", "WARNING", JOptionPane.WARNING_MESSAGE);
	            ...
	            if (title != null && title.length() > 0) {
	                ...
	                if (deadline != null && deadline.getTime() > System.currentTimeMillis()) {
	                  ...
	                  notifyUser("PUT FOR BUY: "+title+" at max "+maxCost+" by "+deadline);
	                            ...
	                            JOptionPane.showMessageDialog(ProductBuyerGuiImpl.this, "Invalid max cost", "WARNING", JOptionPane.WARNING_MESSAGE);
	                        ...
	                        JOptionPane.showMessageDialog(ProductBuyerGuiImpl.this, "Invalid best cost", "WARNING", JOptionPane.WARNING_MESSAGE);
	                    ...
	                    JOptionPane.showMessageDialog(ProductBuyerGuiImpl.this, "Invalid deadline", "WARNING", JOptionPane.WARNING_MESSAGE);
	                ...
	                JOptionPane.showMessageDialog(ProductBuyerGuiImpl.this, "No Product title specified", "WARNING", JOptionPane.WARNING_MESSAGE);
	    ...
	    public void setAgent(ProductBuyerAgent a) {
